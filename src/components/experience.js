...
function Experience() {
    ...
    return (
        <div id="three" class="experience-section">
            <h1>Experience</h1>
            <div class="gaming" >
                <div class="card" id="card1">
                    <span>
                        <img class="experience-logo" src={opentext} alt="" />
                    </span>
                    <h3>
                        Software Developer
                    <br />
                        <h5><Calendar2 /> <i>Sept 2020 - Dec 2020</i></h5>
                    </h3>
                ...
                <div class="card" id="card2">
                    <span>
                        <img class="experience-logo" src={wework} alt="" />
                    </span>
                    <h3>
                        Software Engineering Intern
                    <br />
                        <h5><Calendar2 /> <i>Jan 2020 - April 2020</i></h5>
                    </h3>
                    <div class="text-card">
                        <ul>
                            <li>
